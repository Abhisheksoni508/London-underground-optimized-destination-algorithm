...
def generate_and_time_path(num):
    ...
    print(f'Generating graph with {num} stations...')
    graph = generate_random_graph(num, 0.25, True, False, True, 1, 15)

    selected_stations = list(random_sample(2, num))  # Select 2 random stations from 0 to num-1
...
def num_of_stations():
    # Updated station sizes from 1100 to 2000 in increments of 100
    stations = list(range(1100, 2100, 100))
